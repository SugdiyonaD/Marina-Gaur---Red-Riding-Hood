const story = [
  "Once upon a time there was a dear little girl who was loved by every one who looked at her, but most of all by her grandmother, and there was nothing that she would not have given to the child. Once she gave her a red hood, which suited her so well that she would never wear anything else. So she was always called Little Red Riding Hood.",
  "One day her mother said to her, 'Come, Little Red Riding Hood, here is a piece of cake and a bottle of medicine. Take them to your grandmother, she is ill and weak, and they will do her good. Set out before it gets hot, and when you are going, walk nicely and quietly and do not run off the path, or you may fall and break the basket, and then your grandmother will get nothing. And when you go into her room, don't forget to say, good-morning, and don't peep into every corner before you do it.'",
  ...
  "'Cake and medicine. Yesterday was baking-day, so poor sick grandmother is to have something good, to make her stronger.'",
  ...
  "'Who is there?'",
  "'Little Red Riding Hood,' replied the wolf. 'She is bringing cake and medicine. Open the door.'",
  ...
  "Then all three were delighted. The huntsman drew off the wolf's skin and went home with it. The grandmother ate the cake and drank the medicine which Little Red Riding Hood had brought, and revived, but Little Red Riding Hood thought to herself, 'As long as I live, I will never by myself leave the path, to run into the wood, when my mother has forbidden me to do so.'",
...
nextButton.addEventListener('click', () => {
  ...
  if (currentStoryIndex < story.length) {
    ...
    storyText.innerHTML = "<p>End of the story.</p>";
...
function showStoryText() {
  storyText.innerHTML = "<p>" + story[currentStoryIndex] + "</p>";
}
